...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default='./results/office-homeLN_1022/Ar2Cl_1022',
                        help="output directory of our model (in ../snapshot directory)")
    parser.add_argument('--save_model_name', type=str, default='./checkpoints/office-home_1022/Ar2Cl/model_1022_9999.pth')
