...
if __name__ == "__main__":
    ...
    parser.add_argument('--s_dset_path', type=str, default='./data/office/webcam_list.txt',
    ...
    parser.add_argument('--output_dir', type=str, default='./results/office/W2A_1103_centor_v1',
                        help="output directory of our model (in ../snapshot directory)")
    parser.add_argument('--lr', type=float, default=0.001, help="learning rate")
    parser.add_argument('--centor_w', type=float, default=0.0005)
